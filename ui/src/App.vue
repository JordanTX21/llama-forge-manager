  ...
  <div class="flex h-screen bg-black text-on-surface font-headline overflow-hidden">
    ...
    <header
      ...
      <div class="flex items-center gap-3">
        <h1 class="text-xl font-bold text-on-surface tracking-tight">LlamaForge</h1>
      </div>
    </header>
    ...
    <aside class="hidden md:flex w-72 glass border-r border-outline flex-col z-30">
      ...
      <div class="p-6 border-t border-outline">
        <div class="flex items-center space-x-3 text-sm">
          ...
          <span class="text-on-surface font-label">Engine Online</span>
        </div>
      </div>
    </aside>
    ...
    <nav
      ...
      <router-link to="/"
        ...
        <span class="text-xs font-label">Dashboard</span>
      </router-link>
      <router-link to="/models"
        ...
        <span class="text-xs font-label">Models</span>
      </router-link>
      <router-link to="/settings"
        ...
        <span class="text-xs font-label">Settings</span>
      </router-link>
    </nav>
  </div>
</template>
